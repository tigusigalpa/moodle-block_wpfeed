...
$string['block_wpfeed_settings_wp_api_prefix_desc']   = 'Префикс после URL-адреса сайта для запросов <strong>без слешей</strong>.<br />Префикс по-умолчанию для API v1: <strong>{$a->default_api_prefix_v1}</strong><br />Префикс по-умолчанию для API v2: <strong>{$a->default_api_prefix_v2}</strong><br />URL-адрес запроса к API в результате будет такого вида <strong>http://yoursite.ru/{$a->default_api_prefix_v1}</strong> или <strong>http://yoursite.ru/{$a->default_api_prefix_v2}</strong>';
