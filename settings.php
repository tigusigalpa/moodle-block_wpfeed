...
if ( $ADMIN->fulltree ) {
    ...
    $block_wpfeed_instance = block_wpfeed::getInstance();
    $static_config_obj = (object) $block_wpfeed_instance->static_config;
    
    $settings->add( 
            new admin_setting_configtext( 'block_wpfeed/block_wpfeed_title', get_string( 'block_wpfeed_settings_title', 'block_wpfeed' )
            ,''
            ,$block_wpfeed_instance->static_config['default_block_title'] ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_api_prefix'] ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_post_type'] ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_cache_interval']
            ,PARAM_INT ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_session_store'] ) );
    ...
    $settings->add( 
            ...
            ,''
            ,$block_wpfeed_instance->static_config['default_thumbnail_show'] ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_thumbnail_size'] ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_thumbnail_width']
            ,PARAM_INT ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_thumbnail_link'] ) );
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_posts_limit']
            ,PARAM_INT ) );
    ...
    /*$settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_posts_offset']
            ,PARAM_INT ) );*/
    ...
    $settings->add( 
            ...
            ,$block_wpfeed_instance->static_config['default_post_date'] ) );
    ...
    $settings->add( 
            ...
            ,''
            ,$block_wpfeed_instance->static_config['default_new_window'] ) );
