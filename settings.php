...
if ( $ADMIN->fulltree ) {
    ...
    /*$settings->add( 
            new admin_setting_configtext( 'block_wpfeed/block_wpfeed_posts_offset',
                    get_string( 'block_wpfeed_settings_posts_offset', 'block_wpfeed' ),
            get_string( 'block_wpfeed_settings_posts_offset_desc', 'block_wpfeed' ),
            $blockwpfeedinstance->staticconfig['default_posts_offset'],
            PARAM_INT ) );*/
